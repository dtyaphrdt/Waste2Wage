...
import 'package:intl/intl.dart'; // [IMPORTANT] Add intl to pubspec.yaml
import 'hauler_login.dart';

class HaulerRegisterScreen extends StatefulWidget {
  const HaulerRegisterScreen({super.key});

  @override
  State<HaulerRegisterScreen> createState() => _HaulerRegisterScreenState();
}

class _HaulerRegisterScreenState extends State<HaulerRegisterScreen> {
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        GestureDetector(
                          onTap: () => Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => const HaulerLoginScreen())),
