...
import 'hauler_register.dart'; 
import 'hauler_home.dart'; // <--- Make sure this file exists and has no red errors!

class HaulerLoginScreen extends StatefulWidget {
  const HaulerLoginScreen({super.key});
  @override
  State<HaulerLoginScreen> createState() => _HaulerLoginScreenState();
}

class _HaulerLoginScreenState extends State<HaulerLoginScreen> {
                    ...
                    ElevatedButton(
                      onPressed: () {
                        ...
                        Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(builder: (context) => const HaulerHome()),
                        );
                      },
